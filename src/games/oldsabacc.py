...
class SabaccScreen(QWidget):
    ...
    def __init__(self, state, parent=None):
        ...
        self.ui.sabacc_pot.display(self.pot)
    ...
    def startGameSequence(self):
        ...
        self.ui.UserDialogBox.setPlainText("<-- Choose your number of opponents.")
        self.ui.opponents1.setEnabled(True)
        self.ui.opponents2.setEnabled(True)
        self.ui.opponents3.setEnabled(True)
        self.num_opponents = 0
        self.ui.opponents1.clicked.connect(lambda: self.numOpponents(1))
        self.ui.opponents2.clicked.connect(lambda: self.numOpponents(2))
        self.ui.opponents3.clicked.connect(lambda: self.numOpponents(3))
    ...
    def numOpponents(self, num):
        ...
        self.ui.UserDialogBox.setPlainText("<-- Press Start to begin the game.")
    ...
    def startGame(self):
        ...
        user_player = SabaccPlayer("user", QPointF(260, 450), self)
        self.players.append(user_player)
        print("Added User Player at position (260, 450) with chips:", self.state.chips)
        print("debug2")
        self.game()

    def game(self):
        self.game = Sabacc(self.players, self, self.pot)
